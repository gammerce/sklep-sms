...
class DatabaseSetup
{
    ...
    public function run()
    {
        ...
        $this->db->dropAllTables();
        $this->databaseMigration->setup('abc123', 'admin', 'abc123');
        $this->db->query("INSERT INTO `ss_payment_platforms` (name, module) VALUES ('cssetti', 'cssetti')");
        $this->db->query("INSERT INTO `ss_servers` (name, ip, port) VALUES ('amxx', '172.18.0.5', '27015')");
    }
}
