...
if ($action == "charge_wallet") {
    ...
    if ($action == "antispam_question_add") {
        ...
        if ($db->affected_rows()) {
            log_info($lang_shop->sprintf($lang_shop->translate('question_edit'), $user->getUsername(), $user->getUid(),
                $_POST['id']));
    ...
    // Zwróć info o prawidłowym lub błędnym usunięciu
    if ($db->affected_rows()) {
        log_info($lang_shop->sprintf($lang_shop->translate('question_delete'), $user->getUsername(), $user->getUid(),
            $_POST['id']));
    ...
    if ($db->affected_rows()) {
        // LOGGING
        log_info($lang_shop->sprintf($lang_shop->translate('payment_admin_edit'), $user->getUsername(), $user->getUid(),
            $_POST['id']));
    ...
    if ($action == "service_add") {
        ...
        log_info($lang_shop->sprintf($lang_shop->translate('service_admin_add'), $user->getUsername(), $user->getUid(),
            $_POST['id']));
    ...
    if ($action == "server_add") {
        log_info($lang_shop->sprintf($lang_shop->translate('server_admin_add'), $user->getUsername(), $user->getUid(),
            $server_id));
        json_output('ok', $lang->translate('server_added'), 1);
    } elseif ($action == "server_edit") {
        log_info($lang_shop->sprintf($lang_shop->translate('server_admin_edit'), $user->getUsername(), $user->getUid(),
            $server_id));
    ...
    if ($db->affected_rows()) {
        // LOGGING
        log_info($lang_shop->sprintf($lang_shop->translate('user_admin_edit'), $user->getUsername(), $user->getUid(),
            $_POST['uid']));
    ...
    // Zwróć info o prawidłowym lub błędnym usunięciu
    if ($db->affected_rows()) {
        log_info($lang_shop->sprintf($lang_shop->translate('user_admin_delete'), $user->getUsername(), $user->getUid(),
            $_POST['uid']));
    ...
    if ($action == "group_add") {
        ...
        log_info($lang_shop->sprintf($lang_shop->translate('group_admin_add'), $user->getUsername(), $user->getUid(),
            $db->last_id()));
    ...
    // Zwróć info o prawidłowym lub błędnym usunięciu
    if ($db->affected_rows()) {
        log_info($lang_shop->sprintf($lang_shop->translate('group_admin_delete'), $user->getUsername(), $user->getUid(),
            $_POST['id']));
    ...
    log_info($lang_shop->sprintf($lang_shop->translate('tariff_admin_add'), $user->getUsername(), $user->getUid(),
        $db->last_id()));
    ...
    if ($affected || $db->affected_rows()) {
        log_info($lang_shop->sprintf($lang_shop->translate('tariff_admin_edit'), $user->getUsername(), $user->getUid(),
            $_POST['id']));
    ...
    // Zwróć info o prawidłowym lub błędnym usunięciu
    if ($db->affected_rows()) {
        log_info($lang_shop->sprintf($lang_shop->translate('price_admin_delete'), $user->getUsername(), $user->getUid(),
            $_POST['id']));
    ...
    log_info($lang_shop->sprintf($lang_shop->translate('sms_code_admin_add'), $user->getUsername(), $user->getUid(),
    ...
    log_info($lang_shop->sprintf($lang_shop->translate('code_added_admin'), $user->getUsername(), $user->getUid(),
    ...
    // Zwróć info o prawidłowym lub błędnym usunięciu
    if ($db->affected_rows()) {
        log_info($lang_shop->sprintf($lang_shop->translate('code_deleted_admin'), $user->getUsername(), $user->getUid(),
            $_POST['id']));
