...
return [
    ...
    'log_group_admin_add' => 'Dodano grupę. ID: {1}',
    'log_group_admin_delete' => 'Usunięto grupę. ID: {1}',
    'log_group_admin_edit' => 'Wyedytowano grupę. ID: {1}',
    'log_payment_platform_added' => "Dodano platformę płatności. ID: {1}",
    'log_payment_platform_deleted' => "Usunięto platformę płatności. ID: {1}",
    'log_payment_platform_updated' => "Zaktualizowano platformę płatności. ID: {1}",
    'log_question_delete' => 'Usunięto pytanie anty-spamowe. ID: {1}',
    'log_question_edit' => 'Wyedytowano pytanie anty-spamowe. ID: {1}',
    'log_server_admin_add' => 'Dodano serwer. ID: {1}',
    'log_server_admin_delete' => 'Usunięto serwer. ID: {1}',
    'log_server_admin_edit' => 'Wyedytowano serwer. ID: {1}',
    'logs' => 'Logi',
