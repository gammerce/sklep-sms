...
return [
    ...
    "log_invoice_issue_failure" =>
        "Błąd podczas wystawiania faktury. ID zakupu: [{1}] ID transakcji: [{2}] Błąd: [{3}]",
    ...
    "profile_steam_id_hint" =>
        "Wypełniając to pole, zyskujesz możliwość płacenia portfelem w trakcie gry.",
...
Możesz teraz skorzystać z wielu przydatnych funkcjonalności.',
    ...
    "vat_id" => "NIP",
    "vat_id_hint" => "W przypadku prowadzenia działalności gospodarczej",
