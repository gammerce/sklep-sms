...
return [
    ...
    'log_code_added' => 'Code for service has been added. Code: {1}, Service: {2}',
    'log_code_deleted' => 'Code for service has been deleted. ID: {1}',
    ...
    'log_settings_admin_edited' => 'Shop settings has been edited.',
    'log_sms_code_admin_added' => 'SMS code has been added. Code: {1}, Tariff: {2}',
    'log_sms_code_admin_deleted' => 'SMS code has been deleted. ID: {1}',
    'log_tariff_admin_added' => 'Tariff has been added. ID: {1}',
    'log_tariff_admin_deleted' => 'Tariff has been deleted. ID: {1}',
    'log_tariff_admin_edited' => 'Tariff has been edited. ID: {1}',
    'log_user_admin_deleted' => 'User has been deleted. ID: {1}',
    'log_user_admin_edited' => 'User has been edited. ID: {1}',
    'log_user_service_admin_deleted' => 'User\'s service has been deleted. ID: {1}',
    'logs' => 'Logs',
