...
return [
    ...
    'log_group_admin_add' => 'Group has been added. ID: {1}',
    'log_group_admin_delete' => 'Group has been deleted. ID: {1}',
    'log_group_admin_edit' => 'Group has been edited. ID: {1}',
    ...
    'log_payment_platform_updated' => "Payment platform has been updated. ID: {1}",
    'log_question_delete' => 'Antispam question has been removed. ID: {}',
    'log_question_edit' => 'Antispam question has been edited. ID: {1}',
    'log_server_admin_add' => 'Server has been added. ID: {3}',
    'log_server_admin_delete' => 'Server has been deleted. ID: {3}',
    'log_server_admin_edit' => 'Server has been edited. ID: {3}',
    'logs' => 'Logs',
