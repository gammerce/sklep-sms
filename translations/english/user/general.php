...
return [
    ...
    "log_invoice_issue_failure" =>
        "Failed to issue an invoice. Purchase ID: [{1}] Transaction ID: [{2}] Error: [{3}]",
...
You can now profit from many add-ons.',
    ...
    "vat_id" => "Vat ID",
    "vat_id_hint" => "In the case of owning a company",
    "wallet_charged" => "Wallet was topped up.",
    "wallet_was_charged" => "Wallet was topped up with {1}",
