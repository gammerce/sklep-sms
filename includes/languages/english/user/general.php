...
$l['sms_send_sms'] = "Send SMS";
$l['sms_text'] = "Text";
$l['sms_number'] = "Number";
$l['sms_info_ok'] = "Given return code is correct.";
$l['sms_info_bad_code'] = "Given return code is just incorrect.";
$l['sms_info_bad_number'] = "Code is OK, but unfortunately obtained by sending SMS on different number.";
$l['sms_info_bad_api'] = "Given API is incorrect.";
$l['sms_info_bad_email'] = "E-mail given in payment configuration is incorrect.";
$l['sms_info_server_error'] = "Given API is incorrect, given return code was wrong or another error occured.";
$l['sms_info_misconfiguration'] = "Incorrectly set up payment method, contact the shop owner.";
$l['sms_info_error'] = "An error occured. Cause is unknown.";
$l['sms_info_no_connection'] = "No connection to the verification script.";
$l['sms_info_bad_data'] = "Not all the necessary data were given in payment configuration.";
$l['sms_info_unknown'] = "An unknown error occured. Report it to the shop owner.";
$l['sms_info_sms_not_supported'] = "This service does not operate SMS payment. Report the error to the shop owner.";
$l['transfer_transfer'] = "Transfer";
$l['transfer_transfer_not_supported'] = "This service does not operate transfer payment. Report the error to the shop owner.";
$l['transfer_prepared'] = "Payment preparation successful.<br />In a minute you will be send to transaction service.";
