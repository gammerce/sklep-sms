...
You can now profit from many add-ons.',
    ...
    'sms_cost'                        => 'SMS cost',
    'sms_info_bad_api'                => 'Given API is incorrect.',
    'sms_info_bad_code'               => 'Given return code is just incorrect.',
    'sms_info_bad_data'               => 'Not all the necessary data were given in payment configuration.',
    'sms_info_bad_email'              => 'E-mail given in payment configuration is incorrect.',
    'sms_info_bad_number'             => 'Code is OK, but unfortunately obtained by sending SMS on different number.',
    'sms_info_error'                  => 'An error occured. Cause is unknown.',
    'sms_info_misconfiguration'       => 'Incorrectly set up payment method, contact the shop owner.',
    'sms_info_no_connection'          => 'No connection to the verification script.',
    'sms_info_ok'                     => 'Given return code is correct.',
    'sms_info_server_error'           => 'Given API is incorrect, given return code was wrong or another error occured.',
    'sms_info_sms_not_supported'      => 'This service does not operate SMS payment. Report the error to the shop owner.',
    'sms_info_unknown'                => 'An unknown error occured. Report it to the shop owner.',
    'sms_number'                      => 'Number',
