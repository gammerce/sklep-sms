...
return [
    ...
    'update_available'                      => 'Script update available for version {1}. To download it go to <a href="{2}">WWW website update</a>.',
    'update_available_servers'              => 'Update available for {1}/{2} servers. To download it go to <a href="{3}">Servers update</a>.',
