...
$l['shop_address'] = "Webstore Address";
...
$l['server_first_possibility'] = "We have two possibilities. To download package with latest version of plugins in FULL version, or to update gradually,
		from on version to the next one, using packages with UPDATE version.";
$l['server_second_possibility'] = "We download whole store in latest version <em>(full)</em> or modified files only <em>(update)</em>
				of the next version:";
$l['unzip_arch'] = "We unzip the archive, a następnie kopiujemy pliki na serwer z zachowaniem hierarchii katalogów.";
