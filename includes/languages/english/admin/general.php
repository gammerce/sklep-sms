...
return array(
	...
	'license_soon_expire'                   => 'License expires in: {1} You can prolong it just now: <a href="http://sklep-sms.pl/index.php?page=zakup" target="_blank">Prolong License</a>',
	...
	'web_first_possibility'                 => 'We have two possibilities. To download package with latest version of script in FULL version,  or to update gradually, from one version to the next one, using packages with UPDATE version.',
	'web_second_possibility'                => 'We download whole shop in the latest version: {1} or modified files only of the next version:: {2}',
