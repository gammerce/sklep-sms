...
return [
    ...
    'update_available'                      => 'Dostępna jest aktualizacja skryptu do wersji {1}. Aby ją pobrać przejdź do strony <a href="{2}">Aktualizacja strony WWW</a>.',
    'update_available_servers'              => 'Dostępna jest aktualizacja dla {1}/{2} serwerów. Aby ją pobrać przejdź do strony <a href="{3}">Aktualizacja Serwerów</a>.',
